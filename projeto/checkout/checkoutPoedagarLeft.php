...
<body>
    ...
    <div class="container">
        <img class="imagem" src="../imagens/poedagar1.jpg" alt="">
        <div class="info">
            <h1>Poedagar - White Pearl</h1>
        </div>
        <div class="sobre">
            <p>• Relógio De Luxo Da Marca Poedagar<br>
                ...
                • À prova d'agua<br>
                • Com Luz Noturna<br>
                • Fundo na cor branca</p>
        </div>
        <div class="price">
            <span class="preco-antigo">R$ 359,90</span><br>
            <span class="preco-atual">R$ 159,90</span>
        </div>
        <br><a class="button"href="https://pay.kiwify.com.br/lKNsmz8"><button>ADQUIRA JÁ</button></a>
